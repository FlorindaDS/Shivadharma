...
\fancyhead[LO]{{\'Sivadharmottaram}}
\fancyhead[RE]{{\'Sivadharmottaram}}
...
%%%%%%%% FLORINDA
\newcommand{\msNCfortyfive}{{\rm N$^{\scriptscriptstyle C}_{\scriptscriptstyle 45}$}\allowbreak}
\newcommand{\msNCfortyfivecm}{{\rm N$^{\scriptscriptstyle C}_{\scriptscriptstyle 45{cm}}$}\allowbreak}
\newcommand{\msNKeightytwo}{{\rm N$^{\scriptscriptstyle K}_{\scriptscriptstyle 82}$}\allowbreak}
\newcommand{\msNKeightytwoac}{{\rm N$^{\scriptscriptstyle K}_{\scriptscriptstyle 82}${$^{ac}$\/}}\allowbreak}
\newcommand{\msNKeightytwopc}{{\rm N$^{\scriptscriptstyle K}_{\scriptscriptstyle 82}${$^{pc}$\/}}\allowbreak}
\newcommand{\msNCAtwelve}{{\rm N$^{\scriptscriptstyle Ca}_{\scriptscriptstyle 12}$}\allowbreak}
\newcommand{\msNktwentyeight}{{\rm N$^{\scriptscriptstyle K}_{\scriptscriptstyle 28}$}\allowbreak}
\newcommand{\msNKoseventyseven}{{\rm N$^{\scriptscriptstyle Ko}_{\scriptscriptstyle 77}$}\allowbreak}
\newcommand{\msNKoseventysevencm}{{\rm N$^{\scriptscriptstyle Ko}_{\scriptscriptstyle 77{cm}}$}\allowbreak}
\newcommand{\msNKAtwelve}{{\rm N$^{\scriptscriptstyle Ka}_{\scriptscriptstyle 12}$}\allowbreak}
\newcommand{\msNKAtwelvecm}{{\rm N$^{\scriptscriptstyle Ka}_{\scriptscriptstyle 12{cm}}$}\allowbreak}
\newcommand{\msGPseventyfour}{{\rm G$^{\scriptscriptstyle P}_{\scriptscriptstyle 74}$}\allowbreak}
\newcommand{\msGPseventyfourcm}{{\rm G$^{\scriptscriptstyle P}_{\scriptscriptstyle 74{cm}}$}\allowbreak}
\newcommand{\msGPfortythree}{{\rm G$^{\scriptscriptstyle P}_{\scriptscriptstyle 43}$}\allowbreak}
\newcommand{\msGPfortythreecm}{{\rm G$^{\scriptscriptstyle P}_{\scriptscriptstyle 43{cm}}$}\allowbreak}
\newcommand{\msE}{{\rm E}\allowbreak}
\newcommand{\msP}{{\rm P}\allowbreak}
\newcommand{\msN}{{\rm N}\allowbreak}
\newcommand{\msALL}{{\rm $\Sigma$}\allowbreak}
